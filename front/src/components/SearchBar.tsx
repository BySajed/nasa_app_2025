...
const SearchBar: React.FC<SearchBarProps> = ({ setCity }) => {
    ...
    return (
        <div className="p-4 h-16 flex items-center justify-center w-full border border-secondary rounded-full bg-white focus-within:ring-2 focus-within:ring-secondary">
